...
import { getPreorders, updatePreorderStatus } from '@/app/actions/heatup'
...
export default function PreordersPage() {
  ...
  const filteredRecords = records.filter(r => 
    ...
    r.product_details?.toLowerCase().includes(searchQuery.toLowerCase())
  )

  return (
    <div className="p-4 md:p-8 max-w-[1400px] mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Preorder Requests</h1>
        <p className="text-slate-500">Manage preorder submissions from HeatUp Collection.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-6">
        <div className="p-4 border-b border-slate-200 bg-slate-50">
          <div className="relative max-w-md">
            ...
            <input 
              type="text"
              placeholder="Search by name, contact or details..."
              value={searchQuery}
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-xs uppercase tracking-wider text-slate-500 font-semibold">
                ...
                <th className="p-4 w-1/3">Product Details</th>
